...
class ProductRepositoryTest {
    ...
    public void OneProductInRepository() {
        ...
        Book book2 = new Book(1, "Harry Potter1", 1_300, "RoLings");
    ...
    public void removeNotFoundException() {
        ...
        //Проверка
        Assertions.assertThrows(NotFoundException.class, () -> repo.removeByeID(5));
    }

    //Удаление несуществующего ID 0.
    @Test
    public void removeNotFoundExceptionNull() {
        ProductRepository repo = new ProductRepository();
        Book book1 = new Book(1, "Harry Potter1", 1_200, "RowLings");
        Book book2 = new Book(2, "Harry Potter2", 1_300, "RowLings");
        Smartphone phone1 = new Smartphone(3, "A-10", 25_000, "Samsung");
        ...
        //Проверка
        Assertions.assertThrows(NotFoundException.class, () -> repo.removeByeID(0));
    }
